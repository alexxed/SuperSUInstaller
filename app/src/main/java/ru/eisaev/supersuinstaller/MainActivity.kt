...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Thread.sleep(1_000)
        execCmdNoOutput("cp /sdcard/su /vendor/bin/")
        Thread.sleep(1_000)
        execCmdNoOutput("chmod 755 /vendor/bin/su")
        Thread.sleep(1_000)
        execCmdNoOutput("cp /sdcard/supolicy /vendor/bin/")
        Thread.sleep(1_000)
        execCmdNoOutput("chmod 755 /vendor/bin/supolicy")
        Thread.sleep(1_000)
        execCmdNoOutput("cp /sdcard/libsupol.so /vendor/lib/")
        Thread.sleep(1_000)
        execCmdNoOutput("chmod 644 /vendor/lib/libsupol.so")
        Thread.sleep(1_000)
        execCmdNoOutput("/vendor/bin/su -ad")
    }
